...
namespace APIVerve
{
    public class SentimentAnalysisAPIClient
    {
        ...
        public SentimentAnalysisAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public SentimentAnalysisAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(sentimentanalysisQueryOptions options)
        {
            try
            {
                if (_isDebug)
